export const DEFAULT_AI_SETTINGS = {
  ...
  work_order_summary_prompt: `Write a single natural-language technician summary in 60 words max.
...
{{work_order_data}}
`,
  work_done_prompt: `Write only the customer-facing "Work Done" content based strictly on repair logs.
Output rules:
